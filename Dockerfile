...
RUN    apt-get --yes install git wget imagemagick software-properties-common tmux man python python-pip python-dev vim htop ffmpeg curl
...
RUN    curl -O http://chunkyupdate.llbit.se/ChunkyLauncher.jar; \
